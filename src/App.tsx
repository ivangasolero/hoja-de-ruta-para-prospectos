      ...
      <nav className="fixed top-0 left-0 right-0 z-50 px-6 py-4 flex justify-between items-center glass border-b border-white/5">
        <div className="flex items-center gap-3">
          <Link to="/" className="flex items-center gap-3">
            <img 
              src="https://raw.githubusercontent.com/ivangasolero/hoja-de-ruta-para-prospectos/main/Trading_Sin_Fronteras_Logo__1_-removebg-preview.png" 
              alt="TSF Logo" 
            ...
            <div className="fallback-logo hidden w-10 h-10 bg-accent-cyan rounded-xl flex items-center justify-center text-black font-bold shadow-lg shadow-cyan-500/20">
              <img src="https://raw.githubusercontent.com/ivangasolero/hoja-de-ruta-para-prospectos/main/Trading_Sin_Fronteras_Logo__1_-removebg-preview.png" alt="TSF Logo" style={{width: '35px', height: '35px', objectFit: 'contain'}} />
              TSF
            </div>
